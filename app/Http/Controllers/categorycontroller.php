...
use App\Http\Transformers\TransformerCategory;
...
class categorycontroller extends Controller
{
    ...
    public function index(){
      ...
      return $this->response->collection($a, new TransformerCategory);
    }
    ...
    public function show($id){
      ...
      if ($a) {
        // code...
        return $this->response->item($a, new TransformerCategory);
      } else {
        // code...
